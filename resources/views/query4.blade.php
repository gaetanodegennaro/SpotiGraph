...
@section('content')
    <div class="wrapper fadeInDown" style="height: 100%;">
        <div id="formContent" style="text-align: left; padding-left: 20px;">
            ...
            <h3 class=" fadeIn first" style="margin-top:2%;">Query 4 - Suggerisci una traccia per un utente</h3>
            <br />
            <form method="POST" action="{{Route('exec-query4')}}">
                @csrf
        ...
        <div class="wrapper fadeInDown" style="height: 100%;">
            <div id="formContent" style="text-align: left; padding-left: 20px;">
                ...
                <div style="margin-top: 2%;">
                    @if(!isset($error))
                        <h3>Traccia suggerita per l'utente: {{$utenteSelezionato}}</h3>
                        <br />
